  ...
  return (
    <header className="hero text-center">
      ...
      <div className="hero-about-card mt-4">
        <p>
          Full Stack developer in training with experience in Angular, Node.js, Express, Stripe, and MySQL.
          Led the development of Velonia, an e-commerce platform with inventory management and secure payment integration.
        </p>
      </div>
